...
const createProductWhatsAppHref = (productName) =>
  `https://wa.me/5511999999999?text=${encodeURIComponent(
    `Ola, sinto a sintonia com a Aura. Gostaria de adquirir o produto: ${productName}`
  )}`;
...
export const productCarouselItems = [
  {
    ...
    name: "Perfume Signature",
    category: "Essencia",
    image: "/images/editorial/IMG_3582.JPG",
    href: createProductWhatsAppHref("Perfume Signature Aura")
  },
  {
    id: "carousel-lipstick",
    name: "Velvet Lip Ritual",
    category: "Cosmetico",
    image: "/images/editorial/IMG_3586.JPG",
    href: createProductWhatsAppHref("Velvet Lip Ritual Aura")
  },
  {
    id: "carousel-ring",
    name: "Diamond Presence Ring",
    category: "Joia",
    image: "/images/editorial/IMG_3589.JPG",
    href: createProductWhatsAppHref("Diamond Presence Ring Aura")
  },
  {
    id: "carousel-bracelet",
    name: "Golden Aura Bracelet",
    category: "Joia",
    image: "/images/editorial/IMG_3591.JPG",
    href: createProductWhatsAppHref("Golden Aura Bracelet")
  },
  {
    id: "carousel-earrings",
    name: "Crossover Hoop Earrings",
    category: "Joia",
    image: "/images/editorial/IMG_3593.JPG",
    href: createProductWhatsAppHref("Crossover Hoop Earrings Aura")
  }
];
